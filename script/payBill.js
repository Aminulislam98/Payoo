document.getElementById("pay-bill").addEventListener("click", () => {
  ...
  if (selectBank === "Select Bank") {
    ...
    if (billerAccountNumber.length < 5) {
      ...
      if (newBalance < 0) {
        showSuccessPopupWrong(`
        Insufficient balance. You need an additional $${newBalance} to complete this transaction.
        `);
      } else {
        if (pin === "1234") {
          ...
          >
            ...
            <div class="collapse-content text-sm">
               Your bill payment was completed successfully. Biller Account Number: ${billerAccountNumber} - ${new Date()}
            </div>
